...
namespace DTTS.Web {
    ...
    public partial class DTTSAspNetApplication : WebApplication {
        private DevExpress.ExpressApp.SystemModule.SystemModule module1;
        private DevExpress.ExpressApp.Web.SystemModule.SystemAspNetModule module2;
        private DTTS.Module.DTTSModule module3;
        private DTTS.Module.Web.DTTSAspNetModule module4;
        ...
        private void DTTSAspNetApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
        ...
        private void InitializeComponent() {
            ...
            this.module3 = new DTTS.Module.DTTSModule();
            this.module4 = new DTTS.Module.Web.DTTSAspNetModule();
            ...
            this.securityStrategyComplex1.RoleType = typeof(DTTS.Module.BusinessObjects.EmployeeRole);
            this.securityStrategyComplex1.SupportNavigationPermissionsForTypes = false;
            this.securityStrategyComplex1.UseOptimizedPermissionRequestProcessor = false;
            this.securityStrategyComplex1.UserType = typeof(DTTS.Module.BusinessObjects.Employee);
            // 
            // authenticationStandard1
            // 
            this.authenticationStandard1.LogonParametersType = typeof(DevExpress.ExpressApp.Security.AuthenticationStandardLogonParameters);
            //this.authenticationStandard1.UserLoginInfoType = typeof(DTTS.Module.BusinessObjects.ApplicationUserLoginInfo);
            // 
            // dashboardsModule
            // 
            ...
            // 
            // DTTSAspNetApplication
            // 
            this.ApplicationName = "DTTS";
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.DTTSAspNetApplication_DatabaseVersionMismatch);
